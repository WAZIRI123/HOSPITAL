    ...
    function redirects()
    {
        if (Auth::id()) {
            if (Auth::user()->Usertype == '0') {
                ...
                return view('user.home', compact('data', 'data1', 'data3'));
            } else {
                $data1 = Appointment::all();
                $count = Appointment::all()->count();
                $count1 = User::all()->count();
                $count2 = add_doctor::all()->count();
                $count3 = news::all()->count();
                $data = add_doctor::all();
                return view('admin.home', compact('data', 'data1','count','count1','count2','count3'));
            }
        } else {
            # code...
